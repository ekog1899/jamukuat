$(document).ready(function(){
  $("#btn-search").click(function(){ // Ketika tombol simpan di klik
    ...
    $.ajax({
      url: baseurl + 'perkara/filterProduk', // File tujuan
      type: 'POST', // Tentukan type nya POST atau GET
      data: {keyword: $("#keyword").val()}, // Set data yang akan dikirim
      data: {keyword: $("#validasi").val()}, // Set data yang akan dikirim
      data: {keyword: $("#satker").val()}, // Set data yang akan dikirim
      dataType: "json",
      ...
      success: function(response){ // Ketika proses pengiriman berhasil
        ...
        $("#dataperkara/filterdataprodukac").html(response.hasil);
      },
