...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'jamukuat@pta-semarang.go.id'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Pengadilan Tinggi Agama Semarang'; // Isikan dengan nama pengirim
    protected $password = 'ptasemarang'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->Host = 'mail.pta-semarang.go.id';
       ...
       // $mail->AddEmbeddedImage('image/logo.png', 'logo_mynotescode', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
        ...
        if($send){ // Jika Email berhasil dikirim
            toast('success','&nbsp; Email berhasil dikirim, silahkan cek inbox/ Spam !');
            //$response = array('status'=>'Sukses', 'message'=>'Email berhasil dikirim');
        }else{ // Jika Email Gagal dikirim
            toast('error','&nbsp; Email gagal dikirim! cek email / konfigurasi smtp');
