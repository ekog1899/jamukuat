...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><?php echo $titlemenu;?></h1>
                    ...
                    <tbody>
                        ...
                        foreach($kua->result_array() as $row){
                            ...
                            <tr>
                                ...
                                <td><strong>Penggugat/Pemohon:</strong><br><?php echo $row['nama_pihak1']; ?><br><strong>Tergugat/Termohon:</strong><br><?php echo $row['nama_pihak2']; ?></td>
                                                ...
                                                <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                       <!--  <div class="row">
                                                        ...
                                                        <button type="button" id="cetak" class="btn btn-danger" onclick="cetak_pdf('<?php echo $row['ids'];?>')">cetak</button>
                                                        <div>&nbsp;</div>
...
<script type="text/javascript">
    ...
    function cetak_pdf(id){
        window.open('<?php echo base_url(); ?>kua/kua_detail_pdf/'+id,'_blank');
    };
</script>