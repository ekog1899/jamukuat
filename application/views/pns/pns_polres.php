...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="col-auto">
                    <a href="<?php echo base_url('Pengamanan/polres_putusan');?>"><button class="btn btn-primary pull-right">Perkara Putusan PNS Polres</button></a>
                </div>
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">PERKARA PNS POLRES</h6>
        </div>
        <div class="card-body">
...
function pns_detail(id){
        ...
        b.open("POST", "<?php echo base_url()?>pengamanan/pns_detail", true);
    ...
    document.getElementById("detailclose").onclick = function () {
        location.href = "<?php echo base_url('pengamanan/pns_polres')?>";
    };
</script>