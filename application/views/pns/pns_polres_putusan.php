...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="col-auto">
                    <a href="<?php echo base_url('Pengamanan/pns_polres');?>"><button class="btn btn-primary pull-right">Perkara PNS Polres</button></a>
                </div>
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">PERKARA PUTUSAN PNS POLRES</h6>
        </div>
        <div class="card-body">
