...
function BarisBaru()
{
	...
	Baris += "<input type='hidden' name='mitra_id[]' class='form-control input-sm' value='<?php echo $mitra_id;?>' >";
	Baris += "<input type='hidden' name='pa[]' class='form-control input-sm' value='<?php echo $pa;?>' >";
