...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><a href="<?php echo base_url('Dashboard/dashboard_dukcapil_cari');?>"><button class="btn btn-primary pull-right">Kembali ke Pencarian</button></a></h6>
        ...
        <div class="card-body">
            ...
            <?php 
            if($capil->num_rows()<1){
              echo 'Nama atau NIK <b>'.$cari.'</b> tidak ditemukan';

              ?>
              <form method="POST" action="<?php echo base_url('Dashboard/dashboard_dukcapil_hasil');?>">
         <div class="form-group">
            <label for="varchar">Cari Berdasarkan Nama atau NIK yang lain</label>
