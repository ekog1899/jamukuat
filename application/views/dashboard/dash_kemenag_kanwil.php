   ...
   <!--  <h1 class="h3 mb-4 text-gray-800">KEMENAG</h1> -->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Daftar Kemenag Kabupaten/Kota</h6>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive" id="div_pengguna">
                <table class="table table-bordered table-sm table-hover" id="datauser"  cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $no=1;
                        foreach($kemenag->result_array() as $row){
                            ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                     <a href="<?php echo base_url() ."dashboard/dashboard_kemenag_kanwil/".$row['pengadilan_id']?>"><button type="button" class="btn btn-primary">Detail</button></a> 
                                </center>
                                </td>
