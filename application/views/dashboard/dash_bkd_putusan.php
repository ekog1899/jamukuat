...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">PERKARA PUTUSAN PNS <a href="<?php echo base_url('Dashboard/dashboard_bkd');?>"><button class="btn btn-primary pull-right">Perkara Pendaftaran PNS</button></a></h6>
        </div>
        <div class="card-body">
