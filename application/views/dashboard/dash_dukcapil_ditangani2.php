...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Pihak Yang Dilayani Perubahan Status <a href="<?php echo base_url('Dashboard/dashboard_dukcapil_cari');?>"><button class="btn btn-primary pull-right">Cari Pihak</button></a></h6>
