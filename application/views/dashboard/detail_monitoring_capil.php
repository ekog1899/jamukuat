                ...
                <table class="table table-bordered table-sm table-hover" id="datauser"  cellspacing="0">
                    <thead>
                        <tr class="bg-primary text-light">
                            ...
                            <th style="text-align: center;">Disdukcapil</th>
                            <th style="text-align: center;">Tgl Permohonan Pihak</th>
                            <th style="text-align: center;">Tgl Pengambilan Pihak</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $no2=1;
                        foreach($capil->result_array() as $rows){
                            if($rows['tanggal_permohonan_pihak']==NULL){
                            $tanggal_permohonan_pihak='';
                            }else{

                            $tanggal_permohonan_pihak=tgl_indo($rows['tanggal_permohonan_pihak']);
                            }

                            if($rows['tanggal_pengambilan_pihak']==NULL){
                            $tanggal_pengambilan_pihak='';
                            }else{

                            $tanggal_pengambilan_pihak=tgl_indo($rows['tanggal_pengambilan_pihak']);
                            }
                            ?>
                            <tr>
                                ...
                                <td><center>
                                    ...
                                    <td><center>
                                        ...
                                        <?php
                                    echo $tanggal_pengambilan_pihak;
                                    ?></a>
                                        </center>
                                    </td>
                            </tr>
