...
<div class="row" style="margin-bottom: 10px">       
    ...
    <thead>
        <tr class="bg-primary text-light">
            ...
            <th style="text-align: center;">Status BKD</th>
            <th style="text-align: center;">Unit BKD</th>         
        </tr>
    </thead>
    <tbody>
        <?php
                            ...
                            foreach($pns->result_array() as $row){
                                ...
                                <tr>
                                    ...
                                    <td><center><?php echo $row['satuan_kerja']; ?></center></td>
                                    ...
                                    <td><?php 
                                    if($row['izin_cerai']==0){
                                    	  if($row['status_lapor']=="" || $row['status_lapor']==NULL || $row['status_lapor']==0){
                                        ?>
                                      
                                        <a href="#"><button type="button" class="btn btn-danger">Belum Lapor/Belum Ada Izin Cerai</button></a> 
                                        <?php
                                    }elseif($row['status_lapor']=="1"){
                                        ?>
                                        <a href="#"><button type="button" class="btn btn-success">Sudah Lapor/Ada Izin Cerai</button></a> 
                                        <?php 
