...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			<div>
				<button class='btn text-primary  border border-primary' onclick="tambah_kua(<?php echo $kua_id;?>)"><i class='fa fa-plus'></i> Tambah Key</button></div>
							...
							foreach($key->result_array() as $row){
								...
								<tr>
									...
									<td><center>
										...
										<button class='btn ml-3 btn-sm'><a onClick="return confirmDialog()" href='<?php echo base_url('Pengguna/hapus_key_kua/'.$row['ids'].'/'.$row['mitra_id']);?>' id='HapusBarang'><i class='fa fa-trash' title='Hapus Pengguna'> </i></button></a>
									</center></td>
