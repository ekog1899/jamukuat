...
<script type="text/javascript">
    ...
    function dokumen_soft(id,div){
        ...
        b.send("ht_id=" + btoa("<?php echo $ht_id?>")+"&pa_id=" + btoa(<?php echo $satker?>)+"&instansi_id=" + btoa(id));
    }
...
function kirim_permohonan(id) {
    var conf = confirm("Apakah anda yakin akan Mengirim data ini?");
    if (conf == true) {
...
function edoc_list(){
        ...
        b.send("ht_id=" + btoa("<?php echo $ht_id?>")+"&pa_id=" + btoa(<?php echo $satker?>));
    }
