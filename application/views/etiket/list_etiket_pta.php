...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">DATA E-TIKET (PTA)</h6>
        </div>
        <div class="card-body">
...
function etiket_detail(id){
    ...
    b.open("POST", "<?php echo base_url()?>etiket/etiket_detail_pta", true);
...
function etiket_update(){
    ...
    var url='<?php echo base_url("etiket/etiket_update")?>';
