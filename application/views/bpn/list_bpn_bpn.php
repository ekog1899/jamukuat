...
<div class="container-fluid"> 
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">DATA PERMOHONAN KEPADA ATR/BPN</h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col mr-2">   
    ...
    <div class="modal" id="ModalUploadEdoc">
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-body" id="isi_modal_uploadEdoc">
              ...
              <hr>
              <form id="myDropzoneDokumenEdoc" action="<?php echo base_url('bpn/upload_edoc_jawaban')?>" class="dropzone">
...
<script type="text/javascript"> 
    function bpn_detail(id){
        ...
        b.open("POST", "<?php echo base_url()?>bpn/bpn_detail_bpn", true);
