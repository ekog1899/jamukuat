...
<form name='f_pengamanan' id='f_pengamanan' role='form'>
    <div class="form-group">
        <label for="pilihan_instansi">Instansi <span class="text-danger">*</span></label>
    ...
    <div class="row">
        <div class="col">
            <div class="form-group" >
                    <label for="tanggal_permohonan">Tanggal Surat <span class="text-danger">*</span></label>
                <input type="date" class="form-control" id="tanggal_permohonan" name="tanggal_permohonan" placeholder="">
            </div>
        </div>
        <div class="col">
            <div class="form-group">
                    <label for="nomor_permohonan">Nomor Surat <span class="text-danger">*</span></label>
    ...
    <div class="form-group" style="display: none">
     ...
     <div class="row">
        <div class="col">
            <div class="form-group">
                <label for="pilihan_jenis_pengamanan">Jenis Pengamanan <span class="text-danger">*</span></label>
                <select   id="pilihan_jenis_pengamanan" onchange="pilih_jenis_pengamanan(this.value)">
                    <option value=""></option>
                    <?php
    ...
    <div class="row">
        <div class="col">
            <div class="form-group" >
                <label for="nomor_eksekusi">Nomor Perkara Eksekusi/ Nomor Perkara <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nomor_eksekusi" name="nomor_eksekusi" list="data_nomor_perkara">
                    <small id="nomor_eksekusiHelp" class="form-text text-muted">Silahkan isikan Manual Nomor Perkara atau pilih Nomor Perkara Eksekusi</small>

                <datalist id="data_nomor_perkara">
                  <?php
                        foreach ($nomor as $m):
                            echo '<option value="'.$m->nomor .'">';
                        endforeach; 
                    ?>
                </datalist>
            </div>
